...
def get_example(id):
  ...
  return render_template("index.html", samples="", BUGS_CODE = code_file_contents, DATA_INPUT = data_file_contents, MONITORS_INPUT = monitors_file_contents, INITS_INPUT = inits_file_contents)
